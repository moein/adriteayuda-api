...
<br><br>
Para entrar simplemente entra en <a href="https://adriteayuda.es">adriteayuda.es</a> e introduce tu correo pulsa el botón Entrar. Después vas a recibir un correo electrónico con un enlace de acceso y entrando en ese enlace ya puedes a empezar a usar la aplicación.
<br><br>
¡Muchas gracias y espero que disfrutes de AdriTeAyuda!`;

        await notification.sendMail({subject: 'Bienvenid@ a AdriTeAyuda', html }, email, true);
